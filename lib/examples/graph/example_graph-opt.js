...
var add_graph_opt = require(kangaBase + "/nodes/oneM2M/add-graph-opt");
...
flowchart_random_number_559_params.value_field_name = "r1";
...
var flowchart_random_number_352_params = {};
flowchart_random_number_352_params.klogger = klogger;
flowchart_random_number_352_params.output_name = "r2";
flowchart_random_number_352_params.time_field_name = "x";
flowchart_random_number_352_params.value_field_name = "r2";
flowchart_random_number_352_params.min_value = "1";
flowchart_random_number_352_params.max_value = "50";
flowchart_random_number_352_params.sleeping_time = "1000";
node["flowchart_random_number_352"] = new random_number(flowchart_random_number_352_params);
...
flowchart_add_graph_opt_329_params.y_aixs_field_names = "r1,r2";
flowchart_add_graph_opt_329_params.major_unit = "30";
flowchart_add_graph_opt_329_params.y_label_format = "{0}";
flowchart_add_graph_opt_329_params.locale = "ko-kr";
node["flowchart_add_graph_opt_329"] = new add_graph_opt(flowchart_add_graph_opt_329_params);
...
var flowchart_random_number_352 = function(){
	node["flowchart_random_number_352"].generateEvents(kangaEmitter.emit.bind(kangaEmitter,"flowchart_random_number_352"), true);
};
...
kangaEmitter.on("start",flowchart_random_number_352);

kangaEmitter.on("flowchart_add_graph_opt_329",flowchart_to_socket_io_482);
kangaEmitter.on("flowchart_random_number_352",flowchart_add_graph_opt_329);
