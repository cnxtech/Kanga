...
var fft = require(kangaBase + "/nodes/mathematics/fft");
...
flowchart_event_generator_1_797_params.num_of_events = 1024 * 8;
...
flowchart_event_generator_1_797_params.sleeping_time = "10000";
node["flowchart_event_generator_1_797"] = new event_generator(flowchart_event_generator_1_797_params);

var flowchart_fft_93_params = {};
flowchart_fft_93_params.klogger = klogger;
node["flowchart_fft_93"] = new fft(flowchart_fft_93_params);
...
var flowchart_fft_93 = function(event, isClone){
	event = node["flowchart_fft_93"].execute((isClone === true) ? clone(event) : event);
	kangaEmit("flowchart_fft_93",event, true);
};

// Register the call back functions with kangaEmitter
kangaEmitter.on("start",flowchart_event_generator_1_797);

kangaEmitter.on("flowchart_event_generator_1_797",flowchart_fft_93);
